!(function(t) {
        ...
        (t.exports = function(t, n, r, f) {
          ...
          b
            ...
            : (o(function() {
              ...
              q(m !== Function.prototype ? M(g).concat(M(m)) : M(g), function(
                t,
              ) {
                t in p || h(p, t, g[t]);
              }),
    ...
    ((n = t.exports = function(t, n, r, l, h) {
      ...
      if (o(g)) {
        for (v = c(t.length); v > b; b++)
          if ((y = n ? m(u((p = t[b]))[0], p[1]) : m(t[b])) === a || y === s)
            return y;
      } else
      ...
      if (
        ...
        P ||
          (((b = n(function(n, r) {
            a(n, b, t);
            var e = p(new m(), n, b);
            return void 0 != r && f(r, y, e[S], e), e;
          })).prototype = w),
          (w.constructor = b)),
          (M || F) && (_('delete'), _('has'), y && _('get')),
          (F || O) && _(S),
          g && w.clear && delete w.clear;
      } else
        (b = d.getConstructor(n, t, y, S)), u(b.prototype, r), (c.NEED = !0);
      return (
        v(b, t),
        (x[t] = b),
        i(i.G + i.W + i.F * (b != m), x),
        ...
        ('__proto__' in {}
          ? (function(t, n, e) {
              try {
                (e = r(20)(
                  Function.call,
                  r(15).f(Object.prototype, '__proto__').set,
                  2,
                ))(t, []),
  ...
  function(t, n, r) {
    ...
    var e,
      ...
      m = (t.exports = r(53)('WeakMap', y, g, f, !0, !0));
    s(function() {
  ...
  function(t, n, r) {
    t.exports =
      ...
      !r(3)(function() {
        return (
          7 !=
          Object.defineProperty(r(89)('div'), 'a', {
            get: function() {
              return 7;
            },
          }).a
        ...
        e(t, [
          ...
          },
          {
            ...
            value: function() {
              ...
              (n.textContent = 'Hello I am a paragraph'),
                t.appendChild(n),
  ...
  function(t, n, r) {
    ...
    var e,
      i = r(125);
    var o = new ((e = i) && e.__esModule ? e : { default: e }).default();
    o.sayHi('Hello world'), o.AddToDOM();
  },
  function(t, n) {
    t.exports = function(t, n) {
      var r =
  ...
  function(t, n, r) {
    ...
    var e = r(2),
      ...
      q = function(t) {
        ...
        return (
          !(this === G && i(C, t) && !i(W, t)) &&
          (!(n || !i(this, t) || !i(C, t) || (i(this, k) && this[k][t])) || n)
        );
      },
      X = function(t, n) {
        if (((t = S(t)), (n = w(n, !0)), t !== G || !i(C, n) || i(W, n))) {
          var r = F(t, n);
          return (
            !r || !i(C, n) || (i(t, k) && t[k][n]) || (r.enumerable = !0), r
          );
        }
      },
      $ = function(t) {
        for (var n, r = j(S(t)), e = [], o = 0; r.length > o; )
          i(C, (n = r[o++])) || n == k || n == f || e.push(n);
        return e;
      },
      Z = function(t) {
        for (
          var n, r = t === G, e = j(r ? W : S(t)), o = [], u = 0;
          e.length > u;

        )
          !i(C, (n = e[u++])) || (r && !i(G, n)) || o.push(C[n]);
        return o;
      };
    U ||
      (c(
      ...
      (r(47).f = q),
      (r(61).f = Z),
      o && !r(30) && c(G, 'propertyIsEnumerable', q, !0),
      (p.f = function(t) {
        return Y(v(t));
      })),
    ...
    u(u.S + u.F * !U, 'Symbol', {
      ...
      I.prototype[L] || r(13)(I.prototype, L, I.prototype.valueOf),
      l(I, 'Symbol'),
      l(Math, 'Math', !0),
      l(e.JSON, 'JSON', !0);
  },
  ...
  function(t, n, r) {
    'use strict';
    (function(t) {
      if ((r(327), r(130), r(129), t._babelPolyfill))
